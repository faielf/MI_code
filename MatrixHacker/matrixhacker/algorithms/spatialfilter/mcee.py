...
def fisher_score(data1,data2):
    ...
    '''
    # initialization
    sampleNum1 = data1.shape[0]  
    sampleNum2 = data2.shape[0]    # n_trials
    featureNum1 = data1.shape[-1]  
    featureNum2 = data2.shape[-1]  # n_times
    groupNum = 2     # n_events
    miu1 = np.mean(data1,axis=0)
    miu2 = np.mean(data2,axis=0)  # (n_events, n_times)
